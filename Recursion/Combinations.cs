namespace AlgorithmsPractice.Recursion
{
    internal class Combinations
    {
        ...
        //from d result of rest, form a new collectin by adding d first element
         ...
         * combine each item in combsWithoutCurrentElement with currentElement 
         * & push the result into (combsWithCurrentElement)
